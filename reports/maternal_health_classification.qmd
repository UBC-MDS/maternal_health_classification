...
Based on the scoring of Decision Tree model on the test data, the model has an accuracy of `{python} str(round(test_score*100)) + "%"` which is fairly high, but still leaves room for improvement.
