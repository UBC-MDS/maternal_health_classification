...
## Analysis
To answer our research question we explored several different machine learning models and compared the cross validation results to choose the best one. To accomplish this we used @Python for our analysis, more specifically we used the packages: @numpy, @altair, @pandas, @matplotlib, and @scikit-learn.
